...
const TableRow = (props) => {
    return (<>
        <tr>
            ...
            <td data-title="Name"><b>{props.name}</b></td>
            ...
            <td data-title="Action  " className="place-action">
                ...
                <a href="#" className="view" title="View"><i className="fa-solid fa-eye"></i></a>
                <a href="#" className="delete" title="Delete"><i className="fa-solid fa-trash"></i></a>
            </td>
        </tr>
    </>)
}
const MyAppintment = () => {
    ...
    return (<>
        ...
        <div className="page" style={{ boxShadow: "rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px", borderRadius: "10px" }}>
           <div>
            <nav>
                <div className="nav nav-tabs nav-fill" id="nav-tab" role="tablist" style={{ justifyContent : "center" }}>
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"  role="tab" aria-controls="nav-home" onClick={toggleContentagain}>Upcoming</a>
                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"  role="tab" aria-controls="nav-profile" onClick={toggleContent}>Previous</a>
