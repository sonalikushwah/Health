  ...
  <ResponsiveUserprofile/>
    ...
    <div className="shows">
        ...
        <ul className="profileSlidebar" style={{ padding : "26px 0px 10px" }}>
            ...
            <li>
            <Link onClick={()=>handleChange(9)}  className={`${(id==9) ?"active":""}`}>
            <Tab name="Offers"/>
            </Link>
            </li>
            <li>
            <Link to="/" onClick={()=>handleChange(10)}  className={`${(id==10) ?"active":""}`}>
            <Tab name="Logout"/>
            </Link>
            </li>
            <li>
            <Link onClick={()=>handleChange(11)}  className={`${(id==11) ?"active":""}`}>
