...
const HealthTips = () => {
    ...
    const Card = (props)=>{
        return(<>
        <div className="slick-slide" style={{ margin : "10px" }} class="testimonial-slider layout-02  slick-initialized slick-slider slick-dotted">
                <div>
                    <div _ngcontent-kvm-c19="" className="testimonial-item" style={{ display: "inline-block"}}>
